                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <a href="mailto:landhack049@gmail.com" className="contact__button">Ecrivez moi <i className="uil uil-arrow-right contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://wa.me/237698408048?text=Salut%20Nagoloum%20je%20suis%20intéréssé(e)%20par%20un%20des%20services%20de%20ton%20Portfolio." className="contact__button">Ecrivez moi <i className="uil uil-arrow-right contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://web.facebook.com/daniel.nago.595038" className="contact__button">Ecrivez moi <i className="uil uil-arrow-right contact__button-icon"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div">
                            ...
                            <input type="email" name='email' className='contact__form-input' placeholder='Entrez votre adresse email...' />
                        </div>

                        <div className="contact__form-div contact__form-area">
                            <label className="contact__form-tag">Projet</label>
                            <textarea name="project" cols="30" rows="10" className='contact__form-input' placeholder='Ecrivez votre projet...'></textarea>
                        </div>
