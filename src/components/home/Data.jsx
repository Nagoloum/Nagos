...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description">Je suis un développeur de sites web et applications mobiles responsifs et également trader, je suis passionné et dédié à mon travail.</p>
